...
students[num_students].grade =((students[num_students].marks >= 90)?'A':(students[num_students].marks >= 80)?'B':(students[num_students].marks >= 70)?'C':(students[num_students].marks
num_students++;
}
break;
case 2:
